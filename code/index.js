...
let objInfo = {
    ...
    'אמצעי-מכמ_ד' : {
        ...
        "תת-נושא1" : {
            ...
            "משקפת" : {
                type : "text",
                content: ["דיאופטר: –2 עד +2", "הגדלה: תלוי משקפת", "מיקום: ניידת או על גבי חצובה"], // מערך של תוכן לפי פסקאות
            },
            "מצפן" : {
                type : "text",
                content: ["מיקום: ידני", 'קוטר בועה: עד 2 ס"מ', ""], // מערך של תוכן לפי פסקאות
            },
            "שבשבת" : {
                type : "text",
                content: ["סוללה AA 1.5V: אלקליין", "", ""], // מערך של תוכן לפי פסקאות
            },
            "פריסקופ" : {
                type : "text",
                content: ['מיקום: ממוקם אל מול המפקד והנהג ברק"מ כשהמדפים סגורים', "", ""], // מערך של תוכן לפי פסקאות
            }
        },
    },
    // נושא2-----------------------------------------------------------------------------------------------------------------------
    "אמצעי-צליפה" : {
        ...
        "תת-נושא2" : {
            ...
            "לאופולד-זום" : {
                type : "text",
                content: ["דיאופטר: -4 עד +2", "הגדלה: 6.5 – 20", "טווח יעיל: 1200 מטרים", "מיקום: HTR 0.338 ", "מיקוד: 50  מ' עד אינסוף"], // מערך של תוכן לפי פסקאות
            },
            "מארק-6ירין" : {
                type : "text",
                content: ['דיאופטר -3 :עד +3', 'הגדלה:  3-18', 'טווח יעיל: 1200 מטרים', 'מיקום:  HTR 0.338, SR86, M24', 'מיקוד:100  מטר עד אינסוף', 'סוללה: סוללת ליתיום לתאורת לו"ש'], // מערך של תוכן לפי פסקאות
            },
            "אמ-5" : {
                type : "text",
                content: ['טווח יעיל: 100 -150  מטר', 'מיקום: נק"ל בעל מסילת פיקטיני', 'סוללה:1.5v AA  אלקליין ', 'מצבי הפעלה:  0,1,2,3,4'], // מערך של תוכן לפי פסקאות
            },
            "מארס" : {
                type : "text",
                content: ['מיקום:  תבור M4', 'סוללה: 1.5v AA אלקליין', 'מצבי הפעלה: שמש, עוצמת לייזר (תלוי בסוג הנשק)'], // מערך של תוכן לפי פסקאות
            },
            "זאבון" : {
                type : "text",
                content: ['טווח יעיל: 50 - 200 בקפיצות של 25 מטר, 200 – 335 בקפיצות של 20 מטר', 'מיקום: תבור M4'], // מערך של תוכן לפי פסקאות
            },
            "משקפת-20" : {
                type : "text",
                content: ['דיאופטר: -4 עד +2', 'הגדלה:  12 – 40', 'טווח יעיל: 1200 מטר', 'מיקום: חצובה או ידני'], // מערך של תוכן לפי פסקאות
            },
            "סברובסקי" : {
                type : "text",
                content: ['הגדלה: 30 - 70', 'טווח יעיל: 2100 מטר', 'מיקום:  חצובה'], // מערך של תוכן לפי פסקאות
            },
            "אלירז" : {
                type : "text",
                content: ['סוללה: 1.5v AA אלקליין (רק בסימן 3)', 'מצבי הפעלה: פנס, חלש - איפוס כוונות לילה, חזק - איפוס כוונות יום'], // מערך של תוכן לפי פסקאות
            },
            "מכביםzאקזקט" : {
                type : "text",
                content: ['דיאופטר: -6 עד +2', 'הגדלה: 2 - 4', 'טווח יעיל: 600 מטר', 'מיקום: M16 , גליל, גליל מיקרו, תבור, נגב, מאג', 'סוללה: 4 סוללות 1.5v AA אלקליין/ ליתיום', 'מיקוד: 20 מטר עד אינסוף', 'מצבי הפעלה: תפריט 0,1,2,3'], // מערך של תוכן לפי פסקאות
            },
            "טריג'יקון" : {
                type : "text",
                content: ['דיאופטר: -0.35', 'הגדלה: x4', 'טווח יעיל: 500 מטר', 'מיקום: M16 - A3, M'], // מערך של תוכן לפי פסקאות
            },
            "מפרומר" : {
                type : "text",
                content: ['טווח יעיל: 200 - 250 מטר', 'מיקום: מיקרו תבור (מקלעים(, מאג, נגב, M4, M16', 'סוללה: 1.5v AA אלקליין (1 לשימוש והשנייה רזרבית)', 'מצבי הפעלה: 1,2,3,L, IR'], // מערך של תוכן לפי פסקאות
            },
        },
    },
    // נושא1-----------------------------------------------------------------------------------------------------------------------
    "סמנים" : {
        ...
        "תת-נושא2" : {
            ...
            "LPL-30" : {
                type : "text",
                content: ['אורך גל: 830 nm', 'התבדרות לייזר:0.5  מילירדיאן', 'סוללה: 2 סוללות 1.5v AA  אלקליין', 'מצבי הפעלה: on\off'], // מערך של תוכן לפי פסקאות
            },
            "DAVID" : {
                type : "text",
                content: ['אורך גל:  830 nm', 'התבדרות לייזר: 1-120 מילירדיאן', 'סוללה: 1.5v AA אלקליין', 'מצבי הפעלה: לחיצה רגעית', 'רמת סיכון: class 4'], // מערך של תוכן לפי פסקאות
            },
            "DBAL-I2" : {
                type : "text",
                content: ['אורך גל: 830 - 870 nm', 'התבדרות לייזר:  0.3או 3 mr', 'סוללה: 1.5v AA אלקליין', 'מצבי הפעלה:  off Aim-low Dual-low Aim-high Dual-low/high Dual-high/high', 'רמת סיכון:  class 3'], // מערך של תוכן לפי פסקאות
            },
            "AIM-1" : {
                type : "text",
                content: ['התבדרות לייזר: קו אנכי 0.3 על 7 אלפיות', 'סוללה: 2 סוללות3.5v  ליתיום', 'מצבי הפעלה: תוק, חלש - שלט, חזק - שלט, חלש, חזק', 'רמת סיכון: class 3'], // מערך של תוכן לפי פסקאות
            },
            'מט_ל-למ_מ' : {
                type : "text",
                content: ['סוללה:  2.7Vליתיום', 'רמת סיכון: class 1', 'מצבי הפעלה: לזירה, mode'], // מערך של תוכן לפי פסקאות
            },
            'מט_ל-סרוג' : {
                type : "text",
                content: ['אורך גל:  1064 nm', 'סוללה: מר 2800', 'רמת סיכון: class 3', 'מצבי הפעלה: לזירה'], // מערך של תוכן לפי פסקאות
            },
        },
    },
    // נושא1-----------------------------------------------------------------------------------------------------------------------
    "ראיית-לילה" : {
        ...
        "תת-נושא2" : {
            ...
            "ליאור" : {
                type : "text",
                content: ['דיאופטר: -4.5 עד 2', 'הגדלה: x3 או x4', 'מיקוד: ללא תחום', 'טווח: ליאור x3 300 מטר, ליאורx4  500 מטר, טווח יעיל- 25-300 מטר', 'מיקום:  M4', 'סוללה:1.5v AA  אלקליין', 'מצבי הפעלה: on/off/ptt'], // מערך של תוכן לפי פסקאות
            },
            "אקילה" : {
                type : "text",
                content: ['דיאופטר: -5 עד 2', 'הגדלה: 4x או x6', 'מיקוד: אקילה x4 25 מטר עד אינסוף, אקילה 6x 50 מטר עד אינסוף', 'מיקום: אקילה x4  ע"ג  M16-A3, אקילה x6  ע"ג SR86 M24  ובארט 0.5', 'סוללה:2  סוללות 1.5v AA אלקליין', 'מצבי הפעלה: on/off'], // מערך של תוכן לפי פסקאות
            },
            'שח_ע' : {
                type : "text",
                content: ['דיאופטר: -6 עד 2', 'מיקוד: 25 ס"מ עד אינסוף', 'מיקום: ע"ג רתמת ראש', 'סוללה:1.5v AA  אלקליין', 'מצבי הפעלה: on-v/ on-m/ off/ IR'], // מערך של תוכן לפי פסקאות
            },
            "צגון" : {
                type : "text",
                content: ['סוללה: מר 2800', 'זמן הקלטה: 90 שעות'], // מערך של תוכן לפי פסקאות
            },
            "עדי" : {
                type : "text",
                content: ['דיאופטר: -6 עד +2', 'מיקוד: 25 ס"מ עד אינסוף', 'מיקום: קסדה', 'סוללה: 1.5v AA אלקליין + מארז אחורי של ארבע סוללות', 'מצבי הפעלה: on/off/א"א (קבוע או קפיצי)'], // מערך של תוכן לפי פסקאות
            },
            "עכבר" : {
                type : "text",
                content: ['דיאופטר: -6 עד +2', 'טווח: א"א- 5 מטר', 'מיקום: קסדה', 'סוללה: 2 סוללות 1.5v AA  אלקליין או ליתיום 2.7v', 'מצבי הפעלה: תוק\גע\א"א'], // מערך של תוכן לפי פסקאות
            },
            "Muns" : {
                type : "text",
                content: ['טווח: 1000 מטר', 'מיקום:  HTR 0.338', 'מצבי הפעלה: off/on/בהירות תמונה'], // מערך של תוכן לפי פסקאות
            },
            "T-75" : {
                type : "text",
                content: ['הגדלה: 1-4', 'מיקוד: 15 מטר עד אינסוף', 'מיקום:  MIL 1913', 'סוללה: 3 סוללות ליתיום\אלקליין AA ', 'מצבי הפעלה: on/off ', 'זמן הפעלה: 15 שניות'], // מערך של תוכן לפי פסקאות
            },
            'פנ_מ' : {
                type : "text",
                content: ['דיאופטר: -2 ', 'מיקוד: 15 מטר עד אינסוף', 'מיקום: רק"מ', 'סוללה: 2.7v ליתיום או מתח הרק"מ 24v', 'מצבי הפעלה: גע, תוק ובהירות שפופרת'], // מערך של תוכן לפי פסקאות
            },
            "זרקור" : {
                type : "text",
                content: ['מיקום: ע"ג גיפ, מסוק, רק"מ', 'טווח: מעל25  ס"מ', 'סוללה: מתח ר"מ 24v מתח גיפ 12v', 'מצבי הפעלה: משבת, מתג הפעלה רגעי'], // מערך של תוכן לפי פסקאות
            },
            "נטלי" : {
                type : "text",
                content: ['מיקום: ידני', 'סוללה: מר 2800', 'מצבי הפעלה: א"א, תרמי', 'אורך גל:3-5  או 8-12  מיקרון'], // מערך של תוכן לפי פסקאות
            },
            "עמית" : {
                type : "text",
                content: ['דיאופטר: -6 עד +2', 'הגדלה: ,x2/x4 מכפיל x2/x3', 'מיקום: חצובה\ ידני', 'סוללה: מר 2800', 'מצבי הפעלה:  on/off'], // מערך של תוכן לפי פסקאות
            },
