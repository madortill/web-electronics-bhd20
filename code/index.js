...
let objInfo = {
    ...
    'אמצעי-מכמ_ד' : {
        ...
        "תת-נושא1" : {
            ...
            "מצפן" : {
                type : "text",
                content: ["מיקום: ידני", 'קוטר בועה: עד 2 ס_מ', ""], // מערך של תוכן לפי פסקאות
            },
            "שבשבת" : {
                type : "text",
            ...
            "פריסקופ" : {
                type : "text",
                content: ['מיקום: ממוקם אל מול המפקד והנהג ברק_מ כשהמדפים סגורים', "", ""], // מערך של תוכן לפי פסקאות
            }
        },
    },
    // נושא2-----------------------------------------------------------------------------------------------------------------------
    "אמצעי-צליפה" : {
        ...
        "תת-נושא2" : {
            ...
            "מארק-6ירין" : {
                type : "text",
                content: ['דיאופטר -3 :עד +3', 'הגדלה:  3-18', 'טווח יעיל: 1200 מטרים', 'מיקום:  HTR 0.338, SR86, M24', 'מיקוד:100  מטר עד אינסוף', 'סוללה: סוללת ליתיום לתאורת לו_ש'], // מערך של תוכן לפי פסקאות
            },
            "אמ-5" : {
                type : "text",
                content: ['טווח יעיל: 100 -150  מטר', 'מיקום: נק_ל בעל מסילת פיקטיני', 'סוללה:1.5v AA  אלקליין ', 'מצבי הפעלה:  0,1,2,3,4'], // מערך של תוכן לפי פסקאות
            },
            "מארס" : {
                type : "text",
    ...
    "ראיית-לילה" : {
        ...
        "תת-נושא2" : {
            ...
            "ליאור" : {
                type : "text",
                content: ['דיאופטר: -4.5 עד 2', 'הגדלה: x3או x4', 'מיקוד: ללא תחום', 'טווח: ליאור x3 300 מטר, ליאורx4  500 מטר, טווח יעיל- 25-300 מטר', 'מיקום:  M4', 'סוללה:1.5v AA  אלקליין', 'מצבי הפעלה: on/off/ptt'], // מערך של תוכן לפי פסקאות
            },
            "אקילה" : {
                type : "text",
                content: ['דיאופטר: -5 עד 2', 'הגדלה: 4x או x6', 'מיקוד: אקילה x4 25 מטר עד אינסוף, אקילה 6x 50 מטר עד אינסוף', 'מיקום: אקילה x4  ע_ג  M16-A3, אקילה x6  ע_ג SR86 M24  ובארט 0.5', 'סוללה:2  סוללות 1.5v AA אלקליין', 'מצבי הפעלה: on/off'], // מערך של תוכן לפי פסקאות
            },
            'שח_ע' : {
                type : "text",
                content: ['דיאופטר: -6 עד 2', 'מיקוד: 25 ס_מ עד אינסוף', 'מיקום: ע_ג רתמת ראש', 'סוללה:1.5v AA  אלקליין', 'מצבי הפעלה: on-v/ on-m/ off/ IR'], // מערך של תוכן לפי פסקאות
            },
            "צגון" : {
                type : "text",
            ...
            "עדי" : {
                type : "text",
                content: ['דיאופטר: -6 עד +2', 'מיקוד: 25 ס_מ עד אינסוף', 'מיקום: קסדה', 'סוללה: 1.5v AA אלקליין + מארז אחורי של ארבע סוללות', 'מצבי הפעלה: on/off/א_א (קבוע או קפיצי)'], // מערך של תוכן לפי פסקאות
            },
            "עכבר" : {
                type : "text",
                content: ['דיאופטר: -6 עד +2', 'טווח: א_א- 5 מטר', 'מיקום: קסדה', 'סוללה: 2 סוללות 1.5v AA  אלקליין או ליתיום 2.7v', 'מצבי הפעלה: תוק\גע\א_א'], // מערך של תוכן לפי פסקאות
            },
            "Muns" : {
                type : "text",
            ...
            'פנ_מ' : {
                type : "text",
                content: ['דיאופטר: -2 ', 'מיקוד: 15 מטר עד אינסוף', 'מיקום: רק_מ', 'סוללה: 2.7v ליתיום או מתח הרק_מ 24v', 'מצבי הפעלה: גע, תוק ובהירות שפופרת'], // מערך של תוכן לפי פסקאות
            },
            "זרקור" : {
                type : "text",
                content: ['מיקום: ע_ג גיפ, מסוק, רק_מ', 'טווח: מעל25  ס_מ', 'סוללה: מתח ר_מ 24v מתח גיפ 12v', 'מצבי הפעלה: משבת, מתג הפעלה רגעי'], // מערך של תוכן לפי פסקאות
            },
            "נטלי" : {
                type : "text",
                content: ['מיקום: ידני', 'סוללה: מר 2800', 'מצבי הפעלה: א_א, תרמי', 'אורך גל:3-5  או 8-12  מיקרון'], // מערך של תוכן לפי פסקאות
            },
            "עמית" : {
                type : "text",
